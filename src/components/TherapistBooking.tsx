...
import { Calendar, Clock, Star, Video, MessageSquare, Phone, CheckCircle, CalendarCheck, Globe } from "lucide-react";
...
export const TherapistBooking = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <Card className="mb-8 bg-gradient-to-r from-blue-50 to-indigo-50 border-blue-200">
          <CardHeader>
            <CardTitle className="flex items-center text-blue-800">
              ...
              Your Upcoming Sessions ({userBookings.length})
            </CardTitle>
          </CardHeader>
          <CardContent>
      ...
      {selectedTherapist && !showCalendar && (
