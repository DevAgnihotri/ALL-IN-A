...
const platformBenefits = [
	"EXPERT MATERNAL MENTAL HEALTH ASSISTANCE",
	"POSTPARTUM DEPRESSION TREATMENT", 
	"PREGNANCY ANXIETY SUPPORT",
	"PERINATAL MOOD DISORDER CARE",
	"COMPREHENSIVE COURSES & EDUCATION",
	"EXPERT THERAPIST BOOKING",
			...
			>
				...
				<div className="max-w-4xl mx-auto text-center relative z-10">
					...
					<motion.p 
						...
						variants={itemVariants}
					>
						Join other mothers who have found hope, healing, and support through All in Awareness
					</motion.p>
